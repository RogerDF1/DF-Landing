...
import { useAuth, useUser } from "@clerk/nextjs"; // Importa useUser para obtener la info del usuario
import {
  IconArrowLeft,
  IconBrandTabler,
  IconSettings,
...
export default function OwnSidebar() {
  ...
  return (
    <div
      className={cn(
        "rounded-md flex flex-col md:flex-row   w-full flex-1  mx-auto border  border-neutral-700 overflow-hidden",
      ...
      <Sidebar open={open} setOpen={setOpen}>
        <SidebarBody className="justify-between gap-10">
          <div className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
            {open ? <Icons.logo className="w-8 h-8" /> : <LogoIcon />}
          ...
          <div>
            <SidebarLink
              link={{
                ...
                icon: (
                  <img
                    src={user?.imageUrl || <Icons.logo/>} // Muestra la imagen de perfil o un fallback
                    alt="User Profile"
